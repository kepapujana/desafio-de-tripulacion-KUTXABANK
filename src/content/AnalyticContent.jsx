  ...
  return (
    <div className="analytic-content">
      ...
      <ul className="risk-description-list">
        ...
        <li>
          Alquiler: Puede aumentar debido a reparaciones o incrementos de
          precios.
        </li>
        <li>
          Comidas Fuera: Almuerzos frecuentes fuera de casa pueden afectar el
          presupuesto.
        </li>
        <li>
          Vivienda: Reparaciones, servicios públicos y posibles gastos
          inesperados.
        </li>
      </ul>
      <div className="alert-box">
        ...
        <div className="alert-content">
          <p>
            ¡Atención! Revise sus gastos mensuales y ajuste su presupuesto según
            sea necesario.
          </p>
        </div>
      </div>
